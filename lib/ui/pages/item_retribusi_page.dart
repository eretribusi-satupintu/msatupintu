...
class ItemRetribusiPage extends StatelessWidget {
  final int retribusiId;
  const ItemRetribusiPage({super.key, required this.retribusiId});
          ...
          Container(
            ...
            child: BlocProvider(
              create: (context) => ItemRetribusiSewaBloc()
                ..add(ItemRetribusiSewaGet(retribusiId)),
